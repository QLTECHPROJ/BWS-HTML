...
<div class="home_landingpage">
	...
	<section class="wordfirst_sec text-center" style="background: url('<?php echo get_field('sixth_background_image') ?>') #f9f9f9 no-repeat;">
		<div class="container">
			<h2><?php echo get_field('sixth_title'); ?></h2>
			<?php echo get_field('sixth_content'); ?>
		</div>
	</section><!--wordfirst_sec-->
	<section class="perth_sec" style="background:url('<?php echo get_field('seventh_background_image') ?>') #f9f9f9 no-repeat;">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12">
