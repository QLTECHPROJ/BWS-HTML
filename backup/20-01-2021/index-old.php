            ...
            <div class="justify-content-center d-flex">
                <div class="w-400px">
                    <div class="login-data">
                        ...
                        <h1 class="font-22 text-white">Sign In</h1>
                    </div>
                    ...
                    <div class="form-wrapper">
                        <form class="form" method="POST">
                              ...
                              <div >
                            <label id="lblCountry" class="font-16 text-white">Country</label>
                         ...
                         <!--  <div class="form-group mb-2 input-mobile focused">
                           ...
                           <div class="form-group">
                                <label class="font-16 text-white" for="first">Mobile Number</label>
                                <div class="input-group mb-3">
                          ...
                          <small class="text-white font-13-medium" id="showerrormo" style="display: none">Mobile Number Cannot Be blank</small>
                          <?php
                            }
                            else
                            {
                          ...
                          <small class="text-white font-13-medium" id="showerrormo" style="display: none">Mobile Number Cannot Be blank</small>
                            ...
                            <div class="text-left a-color">
                                <small class="text-white font-13-medium" id="showerror" style="display: none">The Mobile Number entered is not registed. <a href="https://brainwellnessspa.com.au/membership/" class="ml-1" target="_blank">Register Now?</a></small>
                                <small class="text-white font-13-medium" id="showerrordigit" style="display: none">Please Enter the 10 digit mobile number</small>
                            </div>
