                ...
                <div class="w-400px">
                    <div class="login-data">
                        <div class=" text-center top">
                            ...
                            <h1 class="font-22 text-white mb-2">It's Great to see you!</h1>
                            <span class="font-15-light text-white">Mobile Number</span>
                        </div>
                        ...
                        <div class="form-wrapper">
                            <form class="form" method="POST">
                                ...
                                <div class="form-group mb-2">
                                    <label class="font-16 text-white mb-0" for="otp">One Time Password</label>
                                    <input id="otp" class="form-control mobile-input" autocomplete="off" type="text"  name="userotp" />
                                </div>
                                <div class="text-left">
                                    <small class="text-white font-13-medium "></small>
                                </div>
                                ...
                                <a class="text-right mt-3 d-block text-white mt-3 resend font-12-light" id="resend_opt" style="display: none! important">Resend OTP!</a>
                            </form>
                            <?php
