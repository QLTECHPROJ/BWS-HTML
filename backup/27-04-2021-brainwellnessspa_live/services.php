...
<html lang="en">
	<head>
		<title>Booking for Brain Wellness Spa</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		<meta name="description" content="Booking for your session in brainwellnessspa">
	    <meta name="keywords" content="HTML, CSS, JavaScript">
	    <meta name="author" content="brainwellnessspa">
...
.popuprightbx { background: url('https://brainwellnessspa.com.au/bookings/images/exitpopup_kylie.png') no-repeat; background-size: cover !important; background-position: center top !important }	
...
$(document).ready(function() {
        ...
        $('body').prepend('<div id="ouibounce-modal"><div class="overlay"></div><div class="popup exitmodelpopup"> <a class="closePopupCross">×</a><div class="modal-content"><div class="modal-body p-0"><div class="row row-no-gutters"><div class="col-lg-7 col-md-7 col-sm-6 col-6 p-0 popupleftbx"><div class="exitpopup_cntbxpop"><h2>NEED HELP</h2><p>to Improve Your Well-Being and Reclaim Your Quality of Life?</p><div class="book_freebxpop"> <span>Book a <span>25 Mins FREE</span> </span><p>Telehealth Consultation with Terri Bowman</p></div><div class="bookfreebtn"><a href="https://brainwellnessspa.zohobookings.com.au/#/customer/1597000000035035" class="btn-book orgbtn" target="_blank">Yes<span>I need to change my life </span></a><a class="btn-book" id="closeLeavePage">No<span>I m in perfect health </span></a></div></div></div><div class="col-lg-5 col-md-5 col-sm-6 col-6 p-0 popuprightbx">  <img src="https://brainwellnessspa.com.au/bookings/images/exitpopup_kylie.png" alt=""class="desktopimgpop" /><div class="popupterriimgcnt"><h5>Kylie Butler</h5> <p> Facilitator </p></div></div></div></div></div></div></div>');
