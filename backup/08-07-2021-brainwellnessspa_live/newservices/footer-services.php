    ...
    <div class="container">
      ...
      <div class="row justify-content-center align-self-center">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 align-self-center">
          ...
          <a href="<?php echo home_url(); ?>" target='_blank' class="footer_logo"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/footer-logo.png" alt="" class="img-fluid"></a>
...
<script src="https://brainwellnessspa.com.au/wp-content/themes/brainwellnessspa/newservices/js/bootstrap.min.js"></script>
<script type='text/javascript' src='https://brainwellnessspa.com.au/wp-content/themes/brainwellnessspa/vendor/foundation-sites/dist/js/foundation.min.js?ver=6.0'></script>

<script src="https://brainwellnessspa.com.au/wp-content/themes/brainwellnessspa/assets/scripts/scripts.js?ver=1.5"></script>
<script src="https://brainwellnessspa.com.au/wp-content/themes/brainwellnessspa/newservices/js/slick.js"></script>

 <!-- <script src="https://brainwellnessspa.com.au/wp-content/themes/brainwellnessspa/newdepressionlanding/js/jquery.min.js"></script> -->

 <script type='text/javascript' src='https://brainwellnessspa.com.au/wp-content/plugins/wp-smushit/app/assets/js/smush-lazy-load.min.js?ver=3.8.2'></script>
...
jQuery(window).scroll(function() {  // OR  $(window).scroll(function() {
    ...
    var h2 = jQuery(".header_main").height();
    var height = (h2);
    ...
    if(window.matchMedia("(max-width: 767px)").matches){
        var h = jQuery(".header_main").height();
...
jQuery('.onclicksection').on('click', function () {
    ...
    jQuery('html, body').animate({
     ...
     jQuery('.onclicksection').not(this).removeClass('active');
    $id = "#" + jQuery(this).toggleClass('active').attr('data-id');
...
jQuery('.anxitey_cnttitleslider').slick({
...
jQuery('.videotestimonialtabslider').slick({
...
// jQuery('.listrebeca-video[data-video]').one('click', function() {
...
jQuery('.meeteam_slider_bx').slick({
...
jQuery('.tabtesimonail_slider').slick({
...
jQuery('.audiotestimonial_slider').slick({
...
jQuery('.casestudie_slider').slick({
...
jQuery('.documentarytabslider').slick({
...
jQuery('.grapgic_imgslider').slick({
 infinite: true,
 slidesToShow: 1,
  slidesToScroll:1,
  arrows: false,
...
jQuery('.testimonalslider-bxsec ').slick({
 infinite: true,
 slidesToShow: 1,
 adaptiveHeight:true,
 slidesToScroll:1,
...
jQuery('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
  ...
  jQuery('.tabslidercommon').slick('setPosition');
...
<script type="text/javascript">
    ...
    jQuery(function() {
        jQuery('ul li.menusubbx').find('a').addClass('dropdown-toggle');
        jQuery('ul li ul li ').find('a').removeClass('nav-link');
        jQuery('ul li ul li ').find('a').addClass('dropdown-item');
        jQuery('ul li ul').find('a').removeClass('dropdown-toggle');
        
        jQuery('ul li ul li.dropdown-submenu a:first').addClass('dropdown-toggle');
    });
...
jQuery(function(s) {
    ...
    jQuery(".close-modal-link").click(function() {
         jQuery("div.youtube").remove("iframe"), jQuery(".youtube iframe").remove()
    }), 
    s(function() {
        var e = s(".split-list"),
            l = "sub-list";
...
jQuery('.depressiontab_sec .navbar-toggler').click(function() {
    jQuery('.depressiontab_sec .navbar-collapse').slideToggle("slow");
   
  });
jQuery('.onclicksection').click(function() {
    jQuery('.depressiontab_sec .navbar-collapse').slideToggle("slow");
