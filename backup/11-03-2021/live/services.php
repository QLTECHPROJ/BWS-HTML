    ...
    <section class="testimonial-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p>“This really was the last kind of option for me, so I gave it a go and it was the best decision that I’ve ever made. I’m living my best life. It’s the little daily things, like catching up with someone for a coffee, that use to riddle me with anxiety but now I can just do it. I feel really empowered to just live life. Being on such a long mental health journey and not really getting anywhere until I came to the Brain Wellness Spa means the absolute world to me. I’m so grateful to have found this place and I can’t thank the Brain Wellness Spa enough. ”</p>
...
$(document).ready(function() {
        ...
        $('body').prepend('<div id="ouibounce-modal"><div class="overlay"></div><div class="popup exitmodelpopup"> <a class="closePopupCross">×</a><div class="modal-content"><div class="modal-body p-0"><div class="row row-no-gutters"><div class="col-lg-7 col-md-7 col-sm-6 col-6 p-0 popupleftbx"><div class="exitpopup_cntbxpop"><h2>NEED HELP</h2><p>to Improve Your Well-Being and Reclaim Your Quality of Life?</p><div class="book_freebxpop"> <span>Book a <span>15 Mins FREE</span> </span><p>Telehealth Consultation with Terri Bowman</p></div><div class="bookfreebtn"><a href="https://brainwellnessspa.zohobookings.com.au/#/customer/1597000000035035" class="btn-book orgbtn" target="_blank">Yes<span>I need to change my life </span></a><a class="btn-book" id="closeLeavePage">No<span>I m in perfect health </span></a></div></div></div><div class="col-lg-5 col-md-5 col-sm-6 col-6 p-0 popuprightbx"> <img src="images/exitpopupterriimg.png" alt=""class="desktopimgpop" /><div class="popupterriimgcnt"><h5>Terri Bowman</h5> <span>Chief Facilitator</span><p> Creator of Positive <br /> Auditory Stimuli Technique</p></div></div></div></div></div></div></div>');
