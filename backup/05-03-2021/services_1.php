...
.bookfreebtn .btn-book  { display: inline-block; vertical-align: middle; width: 138px; padding: 10px; text-align: center; font-size: 23px;line-height: normal; color: #9f9f9f; background: #e2e2e2;border-radius: 10px; transition: all ease .4s; font-family: 'Montserrat', sans-serif;margin-right: 5px;     font-weight: 700;}
...
.popupleftbx { background-size: cover !important; background: url(../image/exitpopup_bgimg.jpg) no-repeat; }
.exitpopup_cntbxpop{ text-align: center; color: #fff; padding: 50px 60px; font-family: 'Montserrat', sans-serif; }
...
.popuprightbx:before { content: "";position: absolute; left: 2px; top: 0; background: url('../image/exitpopupbg-curvimg.png') no-repeat; width:35px; height: 100%; }
...
$(document).ready(function() {
        ...
        $('body').prepend('<div id="ouibounce-modal"><div class="overlay"></div><div class="popup"><a class="closePopupCross" href="#">×</a></div><div class="modal-content"><div class="modal-body p-0" ><div class="row row-no-gutters"><div class="col-lg-7 col-md-7 col-sm-6 p-0 popupleftbx"><div class="exitpopup_cntbxpop"><h2>NEED HELP</h2><p>to Improve Your Well-Being and Reclaim Your Quality of Life?</p><div class="book_freebxpop"><span>Book a <span>15 Mins FREE</span> </span><p>Telehealth Consultation with Terri Bowman</p></div><div class="bookfreebtn"><a href="https://brainwellnessspa.zohobookings.com.au/#/customer/1597000000035035" class="btn-book orgbtn">Yes<span>I need to change my life </span></a><a href="#" class="btn-book">No<span>I'm in perfect health </span></a></div></div><div class="col-lg-5 col-md-5 col-sm-6 p-0 popuprightbx"><img src="image/terriimgpopup.png" alt=""><div class="popupterriimgcnt"><h5>Terri Bowman</h5><span>Chief Facilitator</span><p>Creator of Positive <br>Auditory Stimuli Technique </p></div></div></div></div></div></div>');
