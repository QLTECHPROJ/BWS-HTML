<footer >
  ...
  <div class="footer_main" style="background-image:url('https://brainwellnessspa.com.au/wp-content/uploads/2021/06/footer-bg-new.jpg') !important;background-position: center top;background-repeat: no-repeat;background-size: cover;">
...
jQuery(function(s) {
    function e() {
        for (var e = document.querySelectorAll(".youtube"), t = 0; t < e.length; t++) ! function(a) {
                ...
                }, n.send(null)) : (o = "https://img.youtube.com/vi/" + a.dataset.embed + "/sddefault.jpg", (e = new Image).src = o, e.addEventListener("load", function() {
                    a.appendChild(e)
                }))
            }(e[t]),
            function(e) {
    ...
    }), s(".close-modal-link").click(function() {
        e(), s("div.youtube").remove("iframe"), s(".youtube iframe").remove()
    }), s(function() {
        var e = s(".split-list"),
            l = "sub-list";
        e.each(function() {
