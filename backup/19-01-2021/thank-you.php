        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="conseteturcntbx">
              <h2 class="mb-4">Lorem ipsum dolor sit amet, consetetur</h2>
              <p class="mb-5">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
              <a href="#." class="getappbtn">GET THE APP <img src="image/Android.svg" alt=""><img src="image/IOS.svg"></a>
            </div><!--conseteturcntbx-->
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
